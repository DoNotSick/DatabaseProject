...
public class DB2022_FrameSIR {
	...
	public DB2022_FrameSIR() {
		...
		lblNewLabel_4.setFont(new Font("援대┝", Font.PLAIN, 20));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DB2022_ManagerMenu ManagerMenu = new DB2022_ManagerMenu();
